...
public void setUp1v1GamePanel() {
  ...
  public void boardButtonsExample() {
    ...
    buttonG.setName("G");
    JButton[] buttons = new JButton[] {buttonA, buttonB, buttonC, buttonD, buttonE, buttonF, buttonG};
    for (JButton button : buttons) {
        button.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
              buttonPlace(button.getName());
            }
  ...
  public void buttonPlace(String letter) {
    switch (letter) {
      case "A":
          //stuff
          break;
